...
## Contributing to sparked-mobile
...
`git remote add upstream https://github.com/SparkEdUAB/sparked-mobile`
...
We use GitHub issues to track public bugs. Report a bug by [opening a new issue](https://github.com/SparkEdUAB/sparked-mobile/issues); it's that easy!  
